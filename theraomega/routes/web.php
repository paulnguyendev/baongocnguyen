...
use App\Http\Controllers\Admin\ProductsRealController as AdminProductsRealController;
...
use App\Http\Controllers\FrontEnd\ProductsRealController;
...
Route::prefix('')->group(function () {
   ...
   Route::prefix('cart')->controller(CartController::class)->group(function () {
      ...
      Route::get('/remove-all/{id?}', 'removeAll')->name($routeName . '/remove-all');
   });
   // Route::prefix('product')->controller(CartController::class)->group(function () {
   //    $routeName = "product";
   //    Route::get('/', 'index')->name($routeName . '/index');
   //    Route::get('/detail/{id}', 'detail')->name($routeName . '/detail');
   //    Route::get('/remove/{id?}', 'remove')->name($routeName . '/remove');
   // });
   Route::prefix('products-real')->controller(ProductsRealController::class)->group(function () {
      $routeName = "products-real";
      Route::get('/', 'index')->name($routeName . '/index');
      Route::get('/detail/{id?}', 'detail')->name($routeName . '/detail');
      Route::get('/remove/{id?}', 'remove')->name($routeName . '/remove');
   });
   Route::prefix('page')->controller(PageController::class)->group(function () {
      $routeName = "page";
      Route::get('/about-us', 'aboutUs')->name($routeName . '/aboutUs');
      Route::get('/contact-us', 'contactUs')->name($routeName . '/contactUs');
      Route::get('/policy', 'policy')->name($routeName . '/policy');
      Route::get('/faq', 'faq')->name($routeName . '/faq');
      Route::get('/contact', 'contact')->name($routeName . '/contact');
   });
});
// $prefix = "agent-test";
...
Route::prefix($prefix)->group(function () use ($prefix) {
   ...
   Route::middleware('access.adminDashboard')->group(function () use ($prefix) {
      ...
      Route::prefix('products-real')->controller(AdminProductsRealController::class)->group(function () use ($prefix) {
         $routeName = "{$prefix}/products-real";
         Route::get('/', 'index')->name($routeName . '/index');
         Route::get('/form/{id?}', 'form')->name($routeName . '/form');
         Route::get('/detail/{id?}', 'detail')->name($routeName . '/detail');
         Route::get('/data', 'data')->name($routeName . '/data');
