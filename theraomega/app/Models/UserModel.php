...
class UserModel extends Model
{
    ...
    protected $fillable = ['name', 'avatar', 'username', 'password', 'email', 'birthday', 'gender', 'address', 'phone', 'code', 'token', 'secret', 'parent_id', 'role', 'group_id', 'status', 'created_at', 'aff_number', 'is_affiliate', 'level_id', 'level', 'bank_name', 'bank_number', 'bank_owner', 'bank_branch'];
    use HasFactory;
    public function listItems($params = "", $options = "")
    {
        $result = null;
        $query = $this->select('id', 'name', 'avatar', 'username', 'password', 'email', 'birthday', 'gender', 'address', 'phone', 'code', 'token', 'secret', 'parent_id', 'role', 'group_id', 'status', 'created_at', 'aff_number', 'is_affiliate', 'level_id', 'level', 'bank_name', 'bank_number', 'bank_owner', 'bank_branch');
