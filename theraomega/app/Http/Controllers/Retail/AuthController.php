...
use App\Helpers\Retail;
use App\Http\Controllers\Controller;
use App\Models\RetailModel as MainModel;
...
class AuthController extends Controller
{
    ...
    function __construct()
    {
        ...
        $this->prefix =  config('prefix.portal_retail');
        ...
        $this->sessionLogin = config('session_key.retailLogin');
    }
    ...
    public function agentCheckParent(Request $request)
    {
        ...
        if (!$item) {
            ...
            $msg = "Oke";
            $id = $item['id'];
            $fullname = Retail::getInfo($id, 'fullname');
            $thumbnail = Retail::getInfo($id, 'thumbnail');
        }
        $result = [
            'status' => $status,
            'msg' => $msg,
