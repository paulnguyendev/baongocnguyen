...
{
    private $pathViewController     = "staffs.pages.products-real";
    private $controllerName         = "products-real";
    private $routeName         = "admin/products-real";
    private $model;
    ...
    public function save(Request $request)
    {
        ...
        $regular_price = isset($params['regular_price']) ? $params['regular_price'] : "";
        $sale_price = isset($params['sale_price']) ? $params['sale_price'] : "";
        ...
        if (!$regular_price) {
            $error['regular_price'] = "Please enter Regular Price";
        }
        if (!$sale_price) {
