...
namespace App\Http\Controllers\Whosales;

use App\Helpers\License;
use App\Helpers\SendMail;
use App\Helpers\Whosales;
use App\Http\Controllers\Controller;
use App\Models\WhosalesModel as MainModel;
...
class AuthController extends Controller
{
    ...
    function __construct()
    {
        ...
        $this->prefix =  config('prefix.portal_whosales');
        ...
        $this->sessionLogin = config('session_key.whosalesLogin');
    }
    ...
    public function agentCheckParent(Request $request)
    {
        ...
        if (!$item) {
            ...
            $msg = "Oke";
            $id = $item['id'];
            $fullname = Whosales::getInfo($id, 'fullname');
            $thumbnail = Whosales::getInfo($id, 'thumbnail');
        }
        $result = [
            'status' => $status,
            'msg' => $msg,
