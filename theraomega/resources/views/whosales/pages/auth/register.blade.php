@extends('core.auth')
@php
    $title = config('title.portal_license_register');
@endphp
@section('title', $title)
...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <h1 class="text-center title-auth">Whosales Sign Up</h1>
            <div class="p-3">
                <form class="form-horizontal m-t-20" id="form-submit" action="{{ route("{$prefix}/postRegister") }}"
                    method="post">
                        ...
                        {{-- <div class="col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Sponsor ID" id="sponsor_id"
                                    id="sponsor_id" data-url="{{ route("{$prefix}/agentCheckParent") }}" name="sponsor_id">
                                <span class="help-block"></span>
                    ...
                    <div class="form-group m-t-10 mb-0 text-center">
                        Already have account? <a class="text-info" href="{{ route("{$prefix}/login") }}"> Sign In</a>
                    </div>
                </form>
            </div>
        </div>
