        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="d-flex align-items-center justify-content-between card-header-obn">
                    <h4 class="card-title font-20 obn-card-title mt-0">List of Products
                    </h4>
                    <a href="{{ route("{$routeName}/form") }}" class="btn btn-primary">Add new</a>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-xlg non-license-data obn-table" id="licences">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center no-padding-right" width="100"></th>
                                <th style="width:15%">Title</th>
                                <th class="text-center" style="width:20% text-center">Price</th>
