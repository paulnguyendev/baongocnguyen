        ...
        <div class="container-fluid">
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="has-submenu"><a href="{{ route('admin/ambassadors/index') }}"><i
                                class="fas fa-user"></i>Manage Ambassadors</a>
                    ...
                    <li>
                        <a href="{{ route('admin/products-real/index') }}"><i class="fab fa-wpforms"></i>Manage
                            Product</a>
                    </li>
                    <li>
