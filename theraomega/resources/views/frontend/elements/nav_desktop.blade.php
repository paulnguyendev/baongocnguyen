                ...
                <div class="nav-item-box">
                    ...
                    <div class="nav-item">
                        <a href="{{ route('fe_combo/index') }}" class="nav-link">
                            <i class="far fa-box"></i>Tất cả combo
                        </a>
                    </div>
                    <div class="nav-item">
                    ...
                    <div class="nav-item">
                        <a href="{{ route('fe_gift/index') }}" class="nav-link">
                            <i class="far fa-hand-holding-heart"></i>Quà tặng
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{route('fe_youtube/index')}}" class="nav-link">
                            <i class="fal fa-users-class"></i> Đào tạo cộng đồng
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{route('home/index')}}" class="nav-link">
                            <i class="far fa-books"></i>Cảm nhận học viên
                        </a>
                    </div>
