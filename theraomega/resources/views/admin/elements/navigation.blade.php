                ...
                <ul class="list-unstyled float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown"
                            ...
                            <img src="{{ UserHelper::getUserInfo('', 'thumbnail') }}" alt="user"
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a
                                            href="{{ route('mlm_admin_level/index', ['slug' => 'licensed']) }}">License</a>
                                    </li>
                                    <li><a href="{{ route('mlm_admin_level/index', ['slug' => 'non-licensed']) }}">Non-License
                                        </a></li>
                                </ul>
                            </li>
